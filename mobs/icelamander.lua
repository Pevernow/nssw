nssw:register_mob("nssw:icelamander", "Icelamander", {
    type = "monster",
    hp_max = 230,
    hp_min = 230,
    ...
    drops = {
        ...
        min = 6,
        max = 8},
        {name = "nssw:frosted_amphibian_heart",
        chance = 1,
        min = 1,
        max = 1},
        {name = "nssw:ice_tooth",
        ...
        min = 1,
        max = 1},
        {name = "nssw:little_ice_tooth",
        chance = 1,
        min = 0,
        max = 20},
        {name = "nssw:amphibian_ribs",
        chance = 2,
        min = 1,
        max = 1},
    },
